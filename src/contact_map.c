 ...
 float x,y,z,dx,dy,dz;
  ...
  for (i=0;i<prot.number_of_atoms;i++){
      ...
      if (   ( (strcmp(prot.atoms_of_prot[i].name,"C   ") && strcmp(prot.atoms_of_prot[i].name,"N   ") && strcmp(prot.atoms_of_prot[i].name,"O   ") && strcmp(prot.atoms_of_prot[i].name,"CA  "))
          ...
          && (!strcmp(type,"min")||!strcmp(type,"MIN")) ){
         x=prot.atoms_of_prot[i].x;
         y=prot.atoms_of_prot[i].y;
         z=prot.atoms_of_prot[i].z;
      }
	...
	m=prot.atoms_of_prot[j].res_number;
        if ( abs(prot.atoms_of_prot[i].res_number - prot.atoms_of_prot[j].res_number) > gap || strcmp(prot.atoms_of_prot[i].chain,prot.atoms_of_prot[j].chain)){
          if (!strcmp(prot.atoms_of_prot[j].name,"CA  ") && (!strcmp(type,"ca")||!strcmp(type,"CA")) &&
             ...
             //if (verbose) {printf("\t\t-- Check contact (type %s) %5d\t%5d\t%f\t%c\t%c\t%s\t%s X %f %f Y %f %f Z %f %f\n",type,n,m,d[n][m],prot.atoms_of_prot[ia[n]].res_code[0],prot.atoms_of_prot[ja[m]].res_code[0],prot.atoms_of_prot[ia[n]].name,prot.atoms_of_prot[ja[m]].name,prot.atoms_of_prot[j].x,x,prot.atoms_of_prot[j].y,y,prot.atoms_of_prot[j].z,z);}
          }
          ...
          if (   (!strcmp(type,"MIN")||!strcmp(type,"min")) ){
             ...
             if ( (double)sqrt(dx*dx + dy*dy +  dz*dz) < d[prot.atoms_of_prot[i].res_number][prot.atoms_of_prot[j].res_number]){
                  ...
                  ia[prot.atoms_of_prot[i].res_number]=i;
                  ja[prot.atoms_of_prot[j].res_number]=j;
                  //if (verbose) {printf("\t\t-- Check contact (type %s) %5d\t%5d\t%f\t%c\t%c\t%s\t%s X %f %f Y %f %f Z %f %f\n",type,n,m,d[n][m],prot.atoms_of_prot[ia[n]].res_code[0],prot.atoms_of_prot[ja[m]].res_code[0],prot.atoms_of_prot[ia[n]].name,prot.atoms_of_prot[ja[m]].name,prot.atoms_of_prot[ja[m]].x,x,prot.atoms_of_prot[ja[m]].y,y,prot.atoms_of_prot[ja[m]].z,z);}
             }
          }
        }
      }
