...
//Rank and Print Results
        if (Meff > 1){
         ...
         Results_MI_DI(PDB_File,DI_filename,cmap_filename,cmap_off_filename,MI_top_filename,DI_top_filename,gnu_filename,gnu_gif,cmap_ca,contact_ca,cmap_cb,contact_cb,cmap_min,contact_min,nr,l,L,minimum_gap,numseqs,fragment_size,Meff,pos,xpos,SSA,MI,DI,time,verbose);
        }else{
